...
// 初始化ReferenceLineInfo类
bool Frame::CreateReferenceLineInfo() {
  // 从ReferenceLineProvider中获取无人车的短期内规划路径ReferenceLine，并进行收缩操作
...
// ReferenceLineProvider中提取无人车短期内的规划路径，然后一条ReferenceLine&&segments、车辆状态和规划起始点
// 生成对应的ReferenceLineInfo
